...
Запущенный проект можно будет посмотреть по [ссылке](http://localhost:8080/). Вставьте токен в инструментах разработчика, как описано выше. Будет предоставлена информация о текущем пользователе, в том числе его аватар, а также доступны права, соответствующие его роли.
